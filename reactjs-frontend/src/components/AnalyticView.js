...
function AnalyticView(props) {
    ...
    function handleAnalyticView(){      
        ...
        try{
         axios.post(`http://localhost:8080/backend/AnalyticsServlet?clear_date1=${y[0].value}&clear_date2=${y[1].value}&due_in_date1=${y[2].value}&due_in_date2=${y[3].value}&baseline_create_date1=${y[4].value}&baseline_create_date2=${y[5].value}&invoice_currency=${y[6].value}`,data)
